...
public class Messages extends SimpleLocalization {
    ...
    public static String STOCK_BROADCAST, STOCK_PERSONAL, STOCK_LISTING, STOCK_CANCELLED, STOCK_REMOVED, STOCK_NO_STOCK, STOCK_SELLER_NO_STOCK, STOCK_SELF_NO_STOCK, STOCK_CANCEL_NO_STOCK, STOCK_SELLER_LOWEST_PRICE;
    ...
    private static void init() {
        ...
        STOCK_PERSONAL = getString("personal");
